 ...
 * Return: NULL on error, otherwise a ptr to hash table
 */
shash_table_t *shash_table_create(unsigned long int size)
{
	shash_table_t *ht;
 ...
 * @value: The value of hash key
 * Return: If failure 0, and -1 if success
 */
int shash_table_set(shash_table_t *ht, const char *key, const char *value)
{
...
/**
 * shash_table_get - It Retrieve the value with a key in hash table
 * @ht: A ptr to the hash table
 * @key: The key to get the value
 * Return: NULL or value of key in ht otherwise
 */
char *shash_table_get(const shash_table_t *ht, const char *key)
{
	shash_node_t *node;
