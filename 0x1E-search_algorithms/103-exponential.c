...
/**
  ...
  * @array: Ptr to the first array of an element
  * @left: The array starting element to search
  * @right: The array ending element to search
...
/**
  ...
  * @size: The numb of array element
  * @value: The value to search
  * Return: If not present or the array is NULL -1, otherwise index
  */
