...
/**
 * linear_skip - Searches for a value in a linked singly list
 * @list: Ptr to head of an array to search
 * @value: The value to search
 * Return: If not present/the head is NULL, NULL. Otherwise ptr
 */
